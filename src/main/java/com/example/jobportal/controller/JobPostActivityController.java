...
public class JobPostActivityController {
    ...
    public JobPostActivityController(UsersService usersService, JobPostActivityService jobPostActivityService, JobSeekerApplyService jobSeekerApplyService, JobSeekerSaveService jobsSeekerSaveService) {
    ...
    public String searchJobs(Model model,
        ...
        if (!dateSearchFlag && !remote && !type && !StringUtils.hasLength(job) && !StringUtils.hasLength(location)) {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                ...
                List<JobSeekerSave> jobSeekerSaveList = jobsSeekerSaveService.getCandidatesJob((JobSeekerProfile) currentUserProfile);
